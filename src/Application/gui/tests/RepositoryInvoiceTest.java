...
public class RepositoryInvoiceTest {
    ...
    public static void main(String[] args) {
        ...
        produtos1.add(new Product("Lucas", 3, "Ração Premium 15kg", 200.0));
        produtos1.add(new Product("La ele", 2, "Brinquedo de Borracha", 35.0));
        ...
        produtos2.add(new Product("AntiBac", 2, "Antibiótico Pet", 85.0));
        ...
        while (opcao != 0) {
            ...
            switch (opcao) {
                case 1:
                    ...
                    novosProd.add(new Product("Shampoth", 1, "Shampoo Pet", 45.0));
