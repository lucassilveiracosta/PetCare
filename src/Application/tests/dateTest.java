...
public class dateTest {
    static void main(String[] args) {
        ...
        Animal animalTeste = new AnimalDomestico("Bob", "Bulldog", "preto", date.minusYears(2), 20.0, Porte.GIGANTE, Sexo.MACHO, ((Dono) donoTeste), vacinas, Temperamento.DOCIL, true, FaseDaVida.ADULTO);
